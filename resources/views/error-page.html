...
<head>
<meta charset="utf-8">
<title>Human Welfare - Fundraising and Charity HTML Template | 404 Error</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="error-section">
    	<div class="auto-container">
            <figure class="error-image"><img src="images/resource/404-image.png" alt=""></figure>
            <h3>We can’t find the page you’re looking for</h3>
            
            <!--btn box-->
            <div class="btn-box">
                <a class="theme-btn btn-style-two" href="index.html"><span class="flaticon-home"></span> go to home</a>
            </div>
        </div>
    </section>
