...
<head>
<meta charset="utf-8">
<title>Human Welfare - Fundraising and Charity HTML Template | Our Team</title>
<!-- Stylesheets -->
    	...
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="default-team-member alternate col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box clearfix">
                    	<!--Image Column-->
                        <div class="image-column"><figure class="image"><a href="#"><img src="images/resource/team-image-4.jpg" alt=""></a></figure></div>
                        <!--Content Column-->
                        <div class="content-column">
                        	<div class="inner">
                            	<h3>ABRAHAM</h3>
                ...
                <div class="default-team-member col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box clearfix">
                    	<!--Image Column-->
                        <div class="image-column"><figure class="image"><a href="#"><img src="images/resource/team-image-5.jpg" alt=""></a></figure></div>
                        <!--Content Column-->
                        <div class="content-column">
                        	<div class="inner">
                            	<h3>KIMBERLEY</h3>
                ...
                <div class="default-team-member col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box clearfix">
                    	<!--Image Column-->
                        <div class="image-column"><figure class="image"><a href="#"><img src="images/resource/team-image-6.jpg" alt=""></a></figure></div>
                        <!--Content Column-->
                        <div class="content-column">
                        	<div class="inner">
                            	<h3>MEREDIM</h3>
                ...
                <div class="default-team-member alternate col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box clearfix">
                    	<!--Image Column-->
                        <div class="image-column"><figure class="image"><a href="#"><img src="images/resource/team-image-7.jpg" alt=""></a></figure></div>
                        <!--Content Column-->
                        <div class="content-column">
                        	<div class="inner">
                            	<h3>MARIYA</h3>
                ...
                <div class="default-team-member alternate col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box clearfix">
                    	<!--Image Column-->
                        <div class="image-column"><figure class="image"><a href="#"><img src="images/resource/team-image-8.jpg" alt=""></a></figure></div>
                        <!--Content Column-->
                        <div class="content-column">
                        	<div class="inner">
                            	<h3>JUSTIN LUTHER</h3>
