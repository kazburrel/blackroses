                        ...
                        @forelse ($applications as $i => $application)
                            <tr>
                                ...
                                {{-- <td class="text-end">
                                    <div class="d-flex flex-center w-100 me-2">
                                        <span
                                            class=" fw-bolder  d-block fs-7 p-1 px-2 {{ $application->is_approved == true ? 'btn btn-light-success' : 'btn btn-light-danger' }}">{{ $lecturer->status == true ? 'Active' : 'Blocked' }}</span>
                                    </div>
                                </td> --}}
                                {{-- <td class="text-end">
                                    <div class="d-flex text-center w-100 me-2">
                                        <span
                                            class="text-dark fw-bolder  d-block fs-6">{{ Str::words($application->education, 5) }}</span>
                                    </div>
                                </td> --}}
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <div class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            ...
                                            data-bs-target="#kt_modal_add_user-{{ $application->uuid }}">
                                        ...
                                        <div class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_block_user{{ $application->uuid }}">
                                        ...
                                        <a href="#" class="btn btn-icon btn-bg-light btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_1{{ $application->uuid }}"
